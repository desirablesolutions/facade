import type { HeroProps } from "@models/typings/components"
import type { JSXView } from "@models/typings/views"


export const defaultProps: HeroProps = {

}
export default function Hero(props: HeroProps): JSXView<HeroProps> {

    return (
        <section className="relative pb-24 lg:pb-40 overflow-hidden">
            <img
                loading="lazy"
                className="absolute top-0 left-0 w-32 md:w-auto z-10"
                src="saturn-assets/images/headers/star-header-left.png"
                alt=""
            />
                        ...
                        <div className="w-full lg:w-2/5 px-4 mb-16 lg:mb-0">
                            <div className="relative max-w-lg lg:max-w-md mx-auto lg:mx-0">
                                <img
                                    ...
                                    src="saturn-assets/images/headers/image-header-3.png"
                                    alt=""
                                />
